...
function SupportTicketsList() {
  ...
  const detailTouromateNum = (e, touro_mate_num) => {
    ...
    axios
      .get(`${baseUrl}/touromate/touromateNum/${touro_mate_num}`)
      .then((result) => {
  ...
  // 1차 거르고 -> 2차 거르고 -> 3차
  useEffect(() => {
    axios.get(baseUrl + "/touromate-list/touromateList").then((result) => {
      console.log(result);
            ...
            >
              ...
              <tbody className="crancy-table__body">
                {currentItems?.map((touromate, idx) => (
                  <tr key={idx}>
                    <td
                      className="crancy-table__column-1 crancy-table__data-1"
                      onClick={(e) =>
                        detailTouromateNum(e, touromate.touro_mate_num)
                      }
                    >
                      <div className="crancy-table__product--id">
                        <p className="crany-table__product--number">
                          <a to="/ticket-details">
                            {touromate.user_id?.toString()}
                          </a>
                        </p>
                      </div>
                    </td>
                    <td
                      className="crancy-table__column-2 crancy-table__data-2"
                      onClick={(e) =>
                        detailTouromateNum(e, touromate.touro_mate_num)
                      }
                    >
                      <div className="crancy-table__product--id">
                        <p className="crany-table__product--number">
                          <a to="/ticket-details">
                            {touromate.touro_mate_title?.toString()}
                          </a>
                        </p>
                      </div>
                    </td>
                    ...
                    <td
                      className="crancy-table__column-4 crancy-table__data-4"
                      onClick={(e) =>
                        detailTouromateNum(e, touromate.touro_mate_num)
                      }
                    >
                    ...
                    <td
                      className="crancy-table__column-5 crancy-table__data-5"
                      onClick={(e) =>
                        detailTouromateNum(e, touromate.touro_mate_num)
                      }
                    >
