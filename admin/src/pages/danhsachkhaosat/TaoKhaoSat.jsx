        ...
        <div className="container mt-5">
          <div className="card">
            <div className="card-body">
              <h1 className="mb-4">Tạo Khảo Sát</h1>
                    ...
                    <div className="col-12">
                      <div className="crancy-main-form__inner">
                        ...
                        <div className="crancy-main-form__button">
                          <button className="crancy-gbcolor" type="submit" disabled={loading}>
                            <FontAwesomeIcon icon={faCheck} /> Tạo Khảo Sát
                          </button>
                        </div>
                      </div>
                    </div>
